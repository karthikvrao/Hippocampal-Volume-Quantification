...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    # Numpy array needs to be flipped, transposed and normalized to a matrix of values in the range of [0..255]
    # slice = slice_nums[0]
...
if __name__ == "__main__":
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"../../../section2/out/trained_model/model.pth")
