...
if __name__ == "__main__":
    ...
    train_keys, val_test_keys = train_test_split(keys, test_size=0.2, random_state=42)
    val_keys, test_keys = train_test_split(val_test_keys, test_size=0.2, random_state=42)
