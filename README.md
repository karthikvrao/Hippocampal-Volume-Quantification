...
<img src="./readme-images/3D_slicer.png" >
...
In the directory called `section3/out/src` you will find the source code that forms the skeleton of the HippoVolume.AI module.
